...
const WorldCanvas = dynamic(
  () =>
    import("@/components/world/WorldCanvas").then((module) => ({
...
const WorldMapCanvas = dynamic(
  () =>
    import("@/components/world/WorldMapCanvas").then((module) => ({
      default: module.WorldMapCanvas,
    })),
  { ssr: false, loading: () => canvasFallback },
);
        ...
        <>
          <header className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-start justify-between p-5 sm:p-7">
            ...
            <nav className="pointer-events-auto flex items-center gap-4 sm:gap-6">
              <div className="glass flex items-center rounded-full border border-border/40 p-1">
                <button
              ...
              <button
                ...
                className="text-whisper text-xs hover:text-foreground sm:text-sm"
              >
                About
              </button>
              {user ? (
                ...
                <Link href="/auth" className="text-whisper text-xs hover:text-foreground sm:text-sm">
                  Sign in
                </Link>
              )}
            </nav>
          ...
          {aboutOpen ? (
            <div className="glass animate-rise absolute top-20 right-5 z-30 w-[min(20rem,calc(100vw-2.5rem))] rounded-xl p-5 sm:right-7">
              ...
              <button onClick={() => setAboutOpen(false)} className="text-whisper mt-4 hover:text-foreground">
                Close
              </button>
            </div>
          ) : null}
          ...
          <div className="absolute inset-x-0 bottom-6 z-20 flex flex-wrap items-center justify-center gap-3 px-4 sm:bottom-8">
            ...
            <button
              ...
              disabled={travelling}
              className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-3 text-sm text-primary-foreground transition-opacity hover:opacity-90 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:opacity-60"
            >
